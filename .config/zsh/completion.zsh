...
# Taken and modified from https://github.com/z-shell/zsh-fancy-completions
...
# Don't complete . and .. special directories
...
(( ${+_comps} )) || autoload -U compinit && compinit -d "${XDG_CACHE_HOME:-$HOME/.cache}/zsh/.zcompdump"
